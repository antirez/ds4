...
#
# Every arm is run through score_official.  The script deliberately
...
zero only when synthetic tensor parity passes, scorer rows match, and every
...
run_smoke hc_only \
    ...
    DS4_CUDA_NO_Q4_GROUPED_ATTN_A=1 \
    DS4_CUDA_NO_Q4_GROUPED_ATTN_A_PREFILL=1
run_smoke default_fast
run_smoke grouped_q81_rollback DS4_CUDA_NO_Q4_GROUPED_ATTN_A_Q81=1
run_smoke grouped_prefill_rollback DS4_CUDA_NO_Q4_GROUPED_ATTN_A_PREFILL=1
...
run_score hc_only \
    ...
    DS4_CUDA_NO_Q4_GROUPED_ATTN_A=1 \
    DS4_CUDA_NO_Q4_GROUPED_ATTN_A_PREFILL=1
run_score default_fast
run_score grouped_q81_rollback DS4_CUDA_NO_Q4_GROUPED_ATTN_A_Q81=1
run_score grouped_prefill_rollback DS4_CUDA_NO_Q4_GROUPED_ATTN_A_PREFILL=1
