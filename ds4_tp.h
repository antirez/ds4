...
typedef enum {
    ...
    /* Keep NHI frames distinct from upstream's cancellation checkpoint.
     * They are exchanged only between paired builds of this branch. */
    DS4_TP_FRAME_NHI_READY = 23,
    DS4_TP_FRAME_NHI_CLOSED = 24,
} ds4_tp_frame_type;
