 ...
 * pass per row tile reused across 8 heads.  Returns 0 when env
 * DS4_METAL_TURBO3_H8 is set to 0 or any precondition fails (caller falls
 * back to the existing per-head turbo3 launcher). */
