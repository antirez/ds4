...
tests/test_gpu_q8_bsum_host_mask32: tests/test_gpu_q8_bsum_host.c cuda/ds4_q8_k_bsum.h
	$(CC) -O3 -ffast-math -Wall -Wextra -Wno-unknown-pragmas -std=c11 -DDS4_TEST_MASK_BITS=32 -I. -o $@ $<

tests/test_gpu_q8_bsum_host_cuda: tests/test_gpu_q8_bsum_host.c cuda/ds4_q8_k_bsum.h
	$(CC) -O2 -Wall -Wextra -Wno-unknown-pragmas -std=c11 -DDS4_TEST_MASK_BITS=32 -DDS4_TEST_UNDEFINED_MASK -I. -o $@ $<

test-gpu-q8-bsum-host: tests/test_gpu_q8_bsum_host tests/test_gpu_q8_bsum_host_mask32 tests/test_gpu_q8_bsum_host_cuda
	./tests/test_gpu_q8_bsum_host
...
test-rocm-q8-k-quantize:
	HIPCC="$(HIPCC)" ROCM_CFLAGS="$(ROCM_CFLAGS)" python3 tests/test_gpu_q8_quantize.py --backend hip
