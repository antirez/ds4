...
# Name the HIP runtime explicitly. When clang cannot locate the ROCm install
# (for example Fedora's split /usr layout), hipcc drops -lamdhip64 from the
# link and every HIP symbol is left undefined.
