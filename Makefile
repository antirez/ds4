...
CORE_OBJS = ds4.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_metal.o ds4_layer_pack.o ds4_engram.o ds4_dist_v3.o ds4_transport.o ds4_transport_nhi.o
CPU_CORE_OBJS = ds4_cpu.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o ds4_dist_v3.o ds4_transport.o ds4_transport_nhi.o
else
...
CORE_OBJS = ds4.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_layer_pack.o ds4_engram.o $(MMQ_OBJS) ds4_dist_v3.o ds4_transport.o ds4_transport_nhi.o
CPU_CORE_OBJS = ds4_cpu.o ds4_image.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o ds4_dist_v3.o ds4_transport.o ds4_transport_nhi.o
...
ds4.o: ds4.c ds4.h ds4_ssd.h ds4_distributed.h ds4_gpu.h ds4_gpu_tp.h ds4_deepseek41_gpu.h ds4_linux_memory.h ds4_engram.h ds4_tp.h ds4_tp_nhi.h
	$(CC) $(CFLAGS) -c -o $@ ds4.c
...
clean:
	...
	rm -f tests/test_tp_combine_rocm tests/test_graph_deferred_dump_rocm tests/test_tp_nhi_live
	rm -f tests/test_transport tests/test_dist_v3
	rm -f tests/test_rocm_qkv_fusion tests/test_q8_krow_rocm tests/bench_q8_krow_rocm tests/bench_mxfp4_rocm
