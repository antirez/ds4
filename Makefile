...
SAMPLING_TEST :=
METAL_TEST := tests/test_layer_stash
else
...
.PHONY: all help clean test test-metal-session-batch test-mxfp4-cuda test-cuda-session-batch test-cuda-mixed-batch dspark-acceptance dspark-verify-depth mtp-verify-depth cpu cuda cuda-spark cuda-generic cuda-regression strix-halo rocm FORCE

ifeq ($(UNAME_S),Darwin)
.PHONY: metal-decode-schedule-bench metal-prefill-variant-bench check-mxfp4-half-lut test-layer-stash
...
tests/test_layer_stash.o: tests/test_layer_stash.c ds4_gpu.h
	$(CC) $(CFLAGS) -I. -c -o $@ $<

tests/test_layer_stash: tests/test_layer_stash.o ds4_metal.o
	$(CC) $(CFLAGS) -o $@ $^ $(METAL_LDLIBS)

test-layer-stash: tests/test_layer_stash
	./tests/test_layer_stash
...
ds4.o: ds4.c ds4.h ds4_ssd.h ds4_distributed.h ds4_gpu.h ds4_dflash2.inc
	$(CC) $(CFLAGS) -c -o $@ ds4.c
...
ds4_cpu.o: ds4.c ds4.h ds4_ssd.h ds4_distributed.h ds4_gpu.h ds4_dflash2.inc
...
ds4_cuda.o: ds4_cuda.cu ds4_gpu.h ds4_gpu_mgpu.h ds4_iq2_tables_cuda.inc $(CUDA_CONFIG) cuda/mmq/ds4_mmq.h
...
ds4_cpu_test_hooks.o: ds4.c ds4.h ds4_gpu.h ds4_gpu_mgpu.h ds4_layer_pack.h ds4_dflash2.inc
	$(CC) $(CFLAGS) -Wno-unused-function -DDS4_NO_GPU -DDS4_TEST_HOOKS -c -o $@ ds4.c

tests/test_dflash_shape.o: tests/test_dflash_shape.c ds4.h
	$(CC) $(CFLAGS) -I. -c -o $@ $<

tests/test_dflash_shape: tests/test_dflash_shape.o ds4_cpu_test_hooks.o ds4_distributed.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
	$(CC) $(CFLAGS) -o $@ $^ $(LDLIBS)
tests/test_q64a_quant: tests/test_q64a_quant.c gguf-tools/quants.c gguf-tools/quants.h
	$(CC) $(CFLAGS) -Igguf-tools -o $@ tests/test_q64a_quant.c gguf-tools/quants.c $(LDLIBS)
...
test: ds4_test ds4_agent_test ds4-eval q4k-dot-test mxfp4-dot-test \
	...
	tests/test_q64a_quant tests/test_gpu_args $(SAMPLING_TEST) $(METAL_TEST) \
	...
	./tests/test_dflash_shape
	./tests/test_q64a_quant
	./tests/test_gpu_args
ifeq ($(UNAME_S),Darwin)
	./tests/test_layer_stash
endif
...
clean:
	rm -f ds4 ds4-server ds4-bench ds4-eval ds4-agent ds4_cpu ds4_native ds4_server_test ds4_test ds4_agent_test gguf-tools/quality-testing/score_official gguf-tools/quality-testing/score_official.o speed-bench/metal_decode_schedule_bench speed-bench/metal_prefill_variant_bench speed-bench/*.o tests/test_q4k_dot tests/test_mxfp4_dot tests/test_mxfp4_metal tests/test_mxfp4_cuda tests/test_metal_session_batch tests/test_layer_stash tests/test_dflash_shape tests/test_q64a_quant tests/test_gpu_xdev tests/test_gpu_model_cache tests/test_gpu_lookup_cache_strict tests/test_engine_mgpu_refusal tests/test_engine_mgpu_runtime tests/test_engine_correctness tests/test_sampling tests/test_cuda_session_batch tests/test_cuda_mixed_batch tests/*.o *.o tests/cuda_long_context_smoke tests/cuda_long_context_smoke.o tests/test_cuda_session_batch.o tests/test_cuda_mixed_batch.o $(CUDA_CONFIG) $(CUDA_CONFIG).tmp

.PHONY: bench-qwen38 test-qwen38 test-ornith9 test-ornith15 test-ornith
bench-qwen38: ds4-bench
	./speed-bench/bench_qwen38.sh --quick

test-qwen38: ds4 ds4-bench
	./tests/test_qwen38_bench.sh

test-ornith9: ds4 ds4-bench
	./tests/test_ornith9_bench.sh

test-ornith15: ds4 ds4-bench
	./tests/test_ornith15_bench.sh

test-ornith: test-ornith9 test-ornith15
