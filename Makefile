...
.PHONY: all help clean test test-metal-session-batch test-mxfp4-cuda test-cuda-session-batch test-cuda-mixed-batch dspark-mxfp4-quantizer-test dspark-acceptance dspark-verify-depth mtp-verify-depth cpu cuda cuda-spark cuda-generic cuda-regression strix-halo rocm
...
test: ds4_test ds4_agent_test ds4-eval q4k-dot-test mxfp4-dot-test dspark-mxfp4-quantizer-test \
...
dspark-mxfp4-quantizer-test: tests/test_dspark_mxfp4_quantizer
	$(MAKE) -C gguf-tools deepseek4-quantize
	./tests/test_dspark_mxfp4_quantizer gguf-tools/deepseek4-quantize
