...
tests/test_qwen38_indexer.o: tests/test_qwen38_indexer.c ds4_gpu.h
	$(CC) $(CFLAGS) -I. -c -o $@ tests/test_qwen38_indexer.c

tests/test_qwen38_indexer: tests/test_qwen38_indexer.o ds4_metal.o ds4_image.o
	$(CC) $(CFLAGS) -o $@ $^ $(METAL_LDLIBS)

.PHONY: test-qwen38-indexer
test-qwen38-indexer: tests/test_qwen38_indexer
	./tests/test_qwen38_indexer
else
