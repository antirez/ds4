...
CORE_OBJS = ds4.o ds4_image.o ds4_distributed.o ds4_dist_v3.o ds4_transport.o ds4_transport_nhi.o ds4_tp.o ds4_ssd.o ds4_metal.o ds4_layer_pack.o ds4_engram.o
...
CORE_OBJS = ds4.o ds4_image.o ds4_distributed.o ds4_dist_v3.o ds4_transport.o ds4_transport_nhi.o ds4_tp.o ds4_ssd.o ds4_cuda.o ds4_layer_pack.o ds4_engram.o $(MMQ_OBJS)
CPU_CORE_OBJS = ds4_cpu.o ds4_image.o ds4_distributed.o ds4_dist_v3.o ds4_transport.o ds4_transport_nhi.o ds4_tp.o ds4_ssd.o ds4_layer_pack.o
...
tests/test_tp_rdma: tests/test_tp_rdma.o $(filter-out ds4_tp.o,$(CPU_CORE_OBJS)) $(TEST_HOOK_GPU_OBJS)
	$(TEST_HOOK_LINK) -o $@ $^ $(TEST_HOOK_LDLIBS)
...
clean:
	...
	rm -f tests/bench_matvec_poc_rocm
