...
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_add_sigmoid_rows)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_gdn)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_hc_combine)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_hc_group_norm)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_hc_inject)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_hc_mix_silu)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_indexer_expand)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_indexer_keys)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_ple_conv)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_ple_gate)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_qsa)
ROCM_UNAVAILABLE_INT(ds4_gpu_qwen38_router_select_tensor)
