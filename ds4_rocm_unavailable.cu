...
ROCM_UNAVAILABLE_INT(ds4_gpu_attention_decode_heads_multi_tensor)
ROCM_UNAVAILABLE_INT(ds4_gpu_attention_decode_multi_supported)
...
ROCM_UNAVAILABLE_INT(ds4_gpu_head_rms_norm_rope_tail_multi_tensor)
...
ROCM_UNAVAILABLE_INT(ds4_gpu_rope_tail_multi_tensor)
